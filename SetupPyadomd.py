...
class PyadomdSetup:
    def setup(self):
        ...
        # as it will be automatically loaded in future sessions, just not the initial session
        # because it reads the custom.pth when the Python interpreter starts.
        # However, if you want to ensure that the ADOMD.NET path is added to the system path for the 
        # very first run, the lines below explicitly adds it.
        # This the somewhat defeats the purpose of the custom.pth file, as this runs each time anyway
